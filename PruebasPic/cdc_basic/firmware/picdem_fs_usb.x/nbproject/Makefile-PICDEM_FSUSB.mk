...
${OBJECTDIR}/_ext/319695064/buttons.p1: ../../demo_src/buttons.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=32 --float=32 --emi=bytewrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,-asm,-asmfile,-speed,+space,-debug --addrqual=require --mode=pro -P -N255 -I"../../demo_src" -I"/home/jsars/PruebasPic/cdc_basic/firmware/picdem_fs_usb.x" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=0x2000 --output=default,-inhx032 --runtime=default,+clear,-init,-keep,-no_startup,-download,-config,-clib,+plib --output=+mcof,-elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/319695064/buttons.p1  ../../demo_src/buttons.c 
...
${OBJECTDIR}/_ext/319695064/buttons.p1: ../../demo_src/buttons.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/319695064/buttons.p1.d 
	@${RM} ${OBJECTDIR}/_ext/319695064/buttons.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  --double=32 --float=32 --emi=bytewrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,-asm,-asmfile,-speed,+space,-debug --addrqual=require --mode=pro -P -N255 -I"../../demo_src" -I"/home/jsars/PruebasPic/cdc_basic/firmware/picdem_fs_usb.x" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=0x2000 --output=default,-inhx032 --runtime=default,+clear,-init,-keep,-no_startup,-download,-config,-clib,+plib --output=+mcof,-elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/319695064/buttons.p1  ../../demo_src/buttons.c 
	@-${MV} ${OBJECTDIR}/_ext/319695064/buttons.d ${OBJECTDIR}/_ext/319695064/buttons.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/319695064/buttons.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/picdem_fs_usb.x.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/picdem_fs_usb.x.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=none  --double=32 --float=32 --emi=bytewrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,-asm,-asmfile,-speed,+space,-debug --addrqual=require --mode=pro -P -N255 -I"../../demo_src" -I"/home/jsars/PruebasPic/cdc_basic/firmware/picdem_fs_usb.x" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=0x2000 --output=default,-inhx032 --runtime=default,+clear,-init,-keep,-no_startup,-download,-config,-clib,+plib --output=+mcof,-elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"       --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/picdem_fs_usb.x.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/picdem_fs_usb.x.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/picdem_fs_usb.x.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/picdem_fs_usb.x.${IMAGE_TYPE}.map  --double=32 --float=32 --emi=bytewrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,-asm,-asmfile,-speed,+space,-debug --addrqual=require --mode=pro -P -N255 -I"../../demo_src" -I"/home/jsars/PruebasPic/cdc_basic/firmware/picdem_fs_usb.x" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=0x2000 --output=default,-inhx032 --runtime=default,+clear,-init,-keep,-no_startup,-download,-config,-clib,+plib --output=+mcof,-elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/picdem_fs_usb.x.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
