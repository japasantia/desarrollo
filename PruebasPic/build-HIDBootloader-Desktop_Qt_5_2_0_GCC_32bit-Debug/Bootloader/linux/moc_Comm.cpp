...
#include "../../../cendit_bootloader_pc/Bootloader/Comm.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Comm_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Comm_t qt_meta_stringdata_Comm = {
    {
QT_MOC_LITERAL(0, 0, 4),
QT_MOC_LITERAL(1, 5, 14),
QT_MOC_LITERAL(2, 20, 0),
QT_MOC_LITERAL(3, 21, 8)
    },
    "Comm\0SetProgressBar\0\0newValue\0"
};
...
void Comm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Comm::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Comm::SetProgressBar)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Comm::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Comm.data,
      qt_meta_data_Comm,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Comm.stringdata))
...
// SIGNAL 0
void Comm::SetProgressBar(int _t1)
{
