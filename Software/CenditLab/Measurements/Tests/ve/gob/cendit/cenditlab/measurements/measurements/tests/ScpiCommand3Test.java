...
import ve.gob.cendit.cenditlab.measurements.ScpiCommand3;
...
public class ScpiCommand3Test
{
    public static void main(String[] args)
    {
        ...
        ScpiCommand3 cmd1 = new ScpiCommand3(":MEAS:DC: (range), (enable) [dc-value]");
        ScpiCommand3 cmd2 = new ScpiCommand3(":FETCH:ARRAY (min), (max) [array]", bundle);
        ScpiCommand3 cmd3 = new ScpiCommand3(":FETCH:DATA ON", bundle);
